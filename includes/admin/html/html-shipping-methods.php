...
?>
    <tr valign="top">
        <th colspan="2" scope="row" class="titledesc"><?php echo __( 'Configured Shipping filter By Cities  Methods in all shipping zones', 'departamentos-y-ciudades-de-guatemala-para-woocommerce' ) ?></th>
    </tr>
    <tr valign="top">
